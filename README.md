...
- Opening any `.xyz` or `.trj` file launches the 3D viewer.
- Use the molecule icon (**3Dmol Viewer: Toggle 3D/Text View**) in the editor toolbar—or run the command from the palette—to flip between text and 3D.
